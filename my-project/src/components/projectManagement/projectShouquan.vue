          ...
          >
            ...
            <el-table-column label="操作" width="200">
              <template slot-scope="scope">
                ...
                <el-button type="text" size="small" v-if="scope.row.status=='待审核'" >移除</el-button>
                <el-button type="text" size="small" v-else-if="scope.row.status=='运行中'">查看秘钥</el-button>
                <el-button type="text" size="small" v-else-if="scope.row.status=='未审核'">提交审核</el-button>
                <el-button type="text" size="small" v-else>重新审核</el-button>
              </template>
            </el-table-column>
          </el-table>
          <!-- 新增角色 -->
