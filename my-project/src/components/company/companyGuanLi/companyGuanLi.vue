            ...
            <div class="side-nav">
                <ul>
                    ...
                    <li @click="isActiveShow('/companyGuanLi_set')">
                        <router-link to="/companyGuanLi_set" :class="activeShow=='/companyGuanLi_set'||activeShow=='/companyGuanLi'?'active':''">
                            <div class="icon home"></div>
                            <span>公司设置</span>
                        </router-link>
                    </li>
                    <li @click="isActiveShow('/companyGuanLi_user')">
                        <router-link to="/companyGuanLi_user" :class="activeShow=='/companyGuanLi_user'?'active':''">
                            <div class="icon"></div>
                            <span>公司用户</span>
                        </router-link>
                    </li>
